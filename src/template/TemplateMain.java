...
public class TemplateMain {
    public static void doGof() {
        ...
        String footer = "2022.10.23, 박광현";

        Article article = new Article(title, content, footer);
        DisplayArticleTemplate simpleDisplayArticle = new SimpleDisplayArticle(article);
        DisplayArticleTemplate captionDisplayArticle = new CaptionDisplayArticle(article);
